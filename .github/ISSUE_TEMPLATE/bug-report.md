---
name: Bug report
about: Report a bug or unexpected behavior in bevy_mortar_bond
...
- bevy_mortar_bond version (if applicable)
...
3. How are you using bevy_mortar_bond? (e.g., integrating it into your Bevy app, building as a library)
