...
它解决了为内容创作者和游戏设计师集成灵活的外部脚本语言的问题，允许用户方便地定义游戏流程、角色交互和 动态场景。
...
- **dialogue_ui**: 此示例展示了一个功能齐全的对话 UI，具有打字机文本效果、动态 Mortar 事件处理（例如 动画、颜色变化、声音播放）、变量状态管理和条件文本，所有这些都集成到自定义 Bevy UI 中。
- 点击选项按钮会更新对话文本
- 按钮有鼠标悬停和点击的视觉反馈
